function [out] = fit_noisyDelta_cfrule_Bavard_2alpha_1zeta(cfg)
...
pfun = cell(1,5); % prior function (empty = uniform)
...
out.cfg = cfg;
    ...
    function [pt,mt,vt,ut,st,wt] = getp(alpha_c,alpha_u,delta,zeta,tau)
